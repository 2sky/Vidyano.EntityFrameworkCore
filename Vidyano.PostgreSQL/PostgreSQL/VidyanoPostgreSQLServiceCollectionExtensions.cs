...
namespace Vidyano.Service.PostgreSQL
{
    [EditorBrowsable(EditorBrowsableState.Never)]
    public static class VidyanoPostgreSQLServiceCollectionExtensions
    {
        public static IServiceCollection AddVidyanoPostgreSQL(this IServiceCollection services, IConfiguration configuration)
        {
