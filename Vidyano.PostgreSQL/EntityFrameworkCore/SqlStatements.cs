...
namespace Vidyano.Service.EntityFrameworkCore
{
    internal static class SqlStatements
    {
        ...
        public static FormattableString CleanupLogs(int days) => $"delete from \"Vidyano\".\"Logs\" where \"Type\" <> 1 and \"CreatedOn\" < CURRENT_DATE - {days} * INTERVAL '1 day'";
        ...
        public const string PostSynchronize = "DO $_$ BEGIN BEGIN PERFORM public.\"PostSynchronize\"(); insert into \"Vidyano\".\"CacheUpdates\" (\"Id\", \"Timestamp\", \"Data\") values(uuid_generate_v4(), NOW(), ''); EXCEPTION WHEN undefined_function then END; END $_$;";
